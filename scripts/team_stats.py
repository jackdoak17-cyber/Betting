...
def collect_team_series(league_id: int, season_id: int, team_id: int) -> dict:
    """
    Returns:
      {
        'stats': {
...
def main():
    ...
    for idx, (lid, sid, tid, tname) in enumerate(items, 1):
        ...
        coll = collect_team_series(lid, sid, tid)
        entry = {
            "league_id": lid,
            "season_id": sid,
            "team_id": tid,
