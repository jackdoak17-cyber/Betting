...
ROOT = Path(".")
IN_DIR = ROOT / "data" / "team_opponent_stats" / "by_league"
OUT_PATH = ROOT / "data" / "team_opponent_stats" / "summary_by_team.txt"

KEY_LABELS = {
    "opp_shots_on_target_last_n": "Opp SOT",
    "opp_shots_total_last_n": "Opp Shots",
    "opp_fouls_last_n": "Opp Fouls",
    "opp_tackles_last_n": "Opp Tackles",
    "opp_cards_total_last_n": "Opp Cards",
    "opp_saves_last_n": "Opp Saves",
    "opp_goal_kicks_last_n": "Opp GKicks",
    "opp_corners_last_n": "Opp Corners",
}
