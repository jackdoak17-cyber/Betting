...
# -*- coding: utf-8 -*-
"""
Player Stats V3 — Singles (shots & shots on target)
...
OUT_DIR = ROOT / "data" / "value_bets" / "V3 Bets" / "V3 player singles"
OUT_DIR.mkdir(parents=True, exist_ok=True)
OUT_FILE = OUT_DIR / "player_stats_v3.txt"
SHEET_DIR = ROOT / "data" / "value_bets" / "sheets"
SHEET_DIR.mkdir(parents=True, exist_ok=True)
SHEET_FILE = SHEET_DIR / "player_stats_v3_singles.csv"
