...
@@ -173,163 +171,107 @@ def numeric_line_from_row(row: dict) -> Optional[float]:
 ...
 def _last2_pairs(fx_h2h: Optional[dict]) -> List[Tuple[str,int,int]]:
     ...
     for m in meta:
         try:
             ...
             pass
     return out
@@ -351,236 +293,200 @@ def h2h_gate_pass_strict(fx_h2h: Optional[dict], market: str, side: Optional[str
